;;; van-helsing-theme.el --- via Dracula Pro -*- lexical-binding: t; no-byte-compile: t; -*-
...
;;
;;; Variables (retained from Doom's Dracula theme)
...
(def-doom-theme van-helsing
    "Using Dracula Pro's colors."
  ...
  ;; name        default   256       16
  ((bg         '("#0b0d0f" "#0a0d10" nil            ))
   (bg-alt     '("#1f272e" "#29333d" "brightblack"  ))
   (base0      '("#1f272e" "#29333d" "brightblack"  ))
   (base1      '("#29333d" "#33404d" "brightblack"  ))
   (base2      '("#33404c" "#3d4d5c" "brightblack"  ))
   (base3      '("#364049" "#262626" "brightblack"  ))
   (base4      '("#414d58" "#3f3f3f" "brightblack"  ))
   (base5      '("#708da9" "#6a8daf" "brightblack"  ))
   (base6      '("#ededde" "#ebebe0" "brightwhite"  ))
   (base7      '("#d6d6c2" "#d1d1c7" "white"        ))
   (base8      '("#babaab" "#b3b3b3" "white"        ))
   (fg         '("#f8f8f2" "#f9f9f1" "brightwhite"  ))
   (fg-alt     '("#ededde" "#ebebe0" "brightwhite"  ))

   (grey       base4)
   (red        '("#ff9580" "#f99986" "red"          ))
   (orange     '("#ffca80" "#f9c986" "brightred"    ))
   (green      '("#8aff80" "#8ff986" "green"        ))
   (teal       '("#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#ffff80" "#f9f986" "yellow"       ))
   (blue       '("#61bfff" "#66bbff" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#ff80bf" "#f986bf" "magenta"      ))
   (violet     '("#9580ff" "#9986f9" "brightmagenta"))
   (cyan       '("#80ffea" "#86f9e6" "brightcyan"   ))
   (dark-cyan  '("#80ffea" "#86f9e6" "brightcyan"   ))
   ...
   (modeline-bg-l
    (if -modeline-bright
      ...
      `(,(doom-lighten (car bg) 0.1) ,@(cdr base0))))
   (modeline-bg-inactive   `(,(doom-lighten (car bg) 0.015) ,@(cdr base1)))
   (modeline-bg-inactive-l (doom-lighten bg 0.15)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-dracula-comment-bg (doom-lighten bg 0.05) 'unspecified) :italic)
   (mode-line
   ...
   (mode-line-emphasis :foreground (if -modeline-bright base8 violet))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if -modeline-bright modeline-bg violet))
   ;;;; elscreen
